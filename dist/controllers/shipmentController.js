...
exports.addTrackingUpdate = exports.getShipmentTracking = exports.deleteShipment = exports.bulkUpdateShipments = exports.searchShipments = exports.getShipmentStats = exports.updateShipmentStatus = exports.trackShipment = exports.getShipment = exports.getAllShipments = exports.getShipments = exports.createShipment = void 0;
...
// @access  Private
exports.createShipment = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
...
// @access  Private
exports.getShipments = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
...
exports.getAllShipments = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const page = Number.parseInt(req.query.page) || 1;
    const limit = Number.parseInt(req.query.limit) || 10;
    const skip = (page - 1) * limit;
    const shipments = await prisma.shipment.findMany({
...
// @access  Private
exports.getShipment = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const { id } = req.params;
    ...
    if (!shipment) {
        return next((0, errorHandler_1.createError)("Shipment not found", 404));
    }
    // Check if user owns the shipment or is admin
    if (shipment.userId !== req.user.id && req.user.role !== "ADMIN") {
        return next((0, errorHandler_1.createError)("Not authorized to access this shipment", 403));
    }
    const response = {
        success: true,
...
// @access  Public
exports.trackShipment = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        const errorMessages = errors
            .array()
    ...
    if (!shipment) {
        return next((0, errorHandler_1.createError)("Shipment not found with this tracking number", 404));
    }
    const response = {
        success: true,
...
// @access  Private/Admin
exports.updateShipmentStatus = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        const errorMessages = errors
            .array()
    ...
    // Check if user owns the shipment or is admin
    if (shipment.userId !== req.user.id && req.user.role !== "ADMIN") {
        return next((0, errorHandler_1.createError)("Not authorized to update this shipment", 403));
    }
    ...
    const updatedShipment = await prisma.shipment.update({
        ...
        data: {
            status,
            actualDelivery: status === client_1.ShipmentStatus.DELIVERED ? new Date() : null,
        },
        include: {
            user: {
                select: {
...
// @access  Private
exports.getShipmentStats = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
...
// @access  Private
exports.searchShipments = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
...
// @access  Private/Admin
exports.bulkUpdateShipments = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        const errorMessages = errors
            .array()
    ...
    if (!Array.isArray(shipmentIds) || shipmentIds.length === 0) {
        return next((0, errorHandler_1.createError)("Please provide an array of shipment IDs", 400));
    }
    ...
    const updatedShipments = await prisma.shipment.updateMany({
        ...
        data: {
            status,
            actualDelivery: status === client_1.ShipmentStatus.DELIVERED ? new Date() : undefined,
        },
    });
...
// @access  Private/Admin
exports.deleteShipment = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const { id } = req.params;
    const shipment = await prisma.shipment.findUnique({
        where: { id },
    });
    ...
    // Check if user owns the shipment or is admin
    if (shipment.userId !== req.user.id && req.user.role !== "ADMIN") {
        return next((0, errorHandler_1.createError)("Not authorized to delete this shipment", 403));
    }
...
// @access  Private
exports.getShipmentTracking = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const { id } = req.params;
    const shipment = await prisma.shipment.findUnique({
        where: { id },
        select: {
...
// @access  Private/Admin
exports.addTrackingUpdate = (0, errorHandler_1.asyncHandler)(async (req, res, next) => {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        const errorMessages = errors
            .array()
